...
function previewHtml() {
  ...
  return `<!doctype html><html lang="pt-BR"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" href="../templates/styles.css"><link rel="stylesheet" href="../templates/dynamic.css"><link rel="stylesheet" href="../templates/fonts.css"><style>.editor-selected-segment{position:relative!important;z-index:40!important;border-radius:0!important;outline:3px solid #f2c94c!important;outline-offset:-3px!important;scroll-margin:64px}.editor-selected-segment::before{content:"SEGMENTO SELECIONADO";position:absolute;z-index:90;top:0;left:0;padding:5px 8px;background:#f2c94c;color:#302400;font:800 8px/1 "Source Sans 3 Variable","Segoe UI",sans-serif;letter-spacing:.08em;pointer-events:none}.editor-selected-item{position:relative!important;z-index:50!important;border-radius:0!important;outline:3px solid #f28c28!important;outline-offset:2px!important;scroll-margin:90px}</style><script>window.CENTRAL_CONTENT=${serialized};window.CENTRAL_EDITOR_SELECTION=${selection};</script><script defer src="../templates/app.js"></script></head><body><a class="skip" href="#conteudo">Ir para o conteúdo</a><main id="conteudo"></main></body></html>`;
